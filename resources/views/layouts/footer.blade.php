...
<footer class="bg-gradient-to-b from-pink-50 to-white relative">
            ...
            <div class="flex-1 space-y-4 min-w-[250px]">
                ...
                <div class="flex gap-2">
                    <input type="email" placeholder="Your email"
                        class="px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-pink-500 flex-grow">
            ...
            {{-- <div class="flex space-x-6">
                <a href="#" class="text-gray-600 hover:text-pink-500 transition-colors">
                    ...
                    <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                        <path
                            d="M18.77,7.46H14.5v-1.9c0-.9.6-1.1,1-1.1h3V.5L14.17.5C10.24.5,9.1,3.3,9.1,5.47V7.46H5.5v3.4h3.6V20.5h5.4V10.86h3.47l.44-3.4" />
                    </svg>
                </a>
                <a href="#" class="text-gray-600 hover:text-pink-500 transition-colors">
    ...
    <div class="h-2 bg-gradient-to-r from-pink-200 via-rose-300 to-pink-200"></div>
</footer>
